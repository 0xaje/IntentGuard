...
| 5 | **“What exact transactions do you support today?”** | “The verified MVP supports native transfers with value, ERC-20 `transfer`, ERC-20 `approve`, Uniswap V3 `exactInputSingle` swaps, and ERC-2612-style `Permit` typed data. Unknown selectors fail closed. Arbitrary nested multi-calls fail closed as `CANNOT_VERIFY`.” | TypeScript decoder, fixture tests, and supported-scope README. |
